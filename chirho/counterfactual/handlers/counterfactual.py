...
class Splits(Generic[T], pyro.poutine.messenger.Messenger):
    """
    Effect handler that applies the operation :func:`~chirho.counterfactual.ops.split`
    ...
    :param prefix: An optional prefix for naming the auxiliary plates.
    """
