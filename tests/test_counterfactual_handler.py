...
from causal_pyro.counterfactual.index_set import IndexSet, indices_of
from causal_pyro.counterfactual.ops import MultiWorldInterventions
...
def test_multiple_interventions_indexset(nested, x_cf_value, event_shape, cf_dim):
    ...
    with MultiWorldInterventions(cf_dim):
        Z, X, Y = model()
