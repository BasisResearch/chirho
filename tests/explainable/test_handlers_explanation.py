...
def test_edge_eq_neq():
    ...
    assert trace_independent.trace.nodes["__cause____consequent_Y"]["fn"].log_factor[1,0,0,0,:].sum() <0   # I would instead do torch.sumexp being equal to 0 since we want this probability to be zeroi
